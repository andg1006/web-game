...
const dialogues = [
    { speaker: 'choi', text: ' 방금 너무 무서웠어...' },
    { speaker: 'choi', text: ' 얼른 반에 가자..' },
    { speaker: 'an', text: ' 나 잠깐 화장실...' },
    { speaker: 'choi', text: ' 뭔 이 상황에 화장실이야' },
    { speaker: 'choi', text: ' 반 들렸다가 화장실 가자, 여기 빨리 나가고 싶어...' },
    { speaker: 'an', text: ' 알겠어...' },
];
...
function Page8() {
    ...
    const handleClick = () => {
        ...
        if (currentIndex < dialogues.length - 1) {
            ...
            navigate('/web-game/page9');
        }
    };

    return (
        <div className={`page-container bg3-4 ${fadeIn ? 'fade-in' : ''}`}>
            <Menu />
            {showSceneText && <div className="scene-text">- 3층 복도 -</div>}
