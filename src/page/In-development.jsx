...
const dialogues = [
    { speaker: 'choi', text: ' 이 페이지는 현재 개발 중입니다.' },
];
...
function In_development() {
    ...
    const goToLookAround = () => navigate('/web-game/');
    const goToThirdFloor = () => navigate('/web-game/');
                ...
                <div className="right">
                    {!showChoices ? (
                        ...
                        <div className="choice-container">
                            <button className="choice-btn" onClick={goToLookAround}>돌아가기</button>
                            <button className="choice-btn" onClick={goToThirdFloor}>돌아가기</button>
                        </div>
                    )}
                </div>
            </div>
